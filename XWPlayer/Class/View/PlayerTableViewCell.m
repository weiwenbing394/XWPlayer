...
- (void)bulidPlayerCell{
    ...
    _linesView.backgroundColor = [UIColor lightGrayColor];
...
- (void)setPlayerModel:(PlayerModel *)playerModel{
    ...
    [_iconImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://img.meelive.cn/%@",playerModel.portrait]] placeholderImage:[UIImage imageNamed:@"liveRoom"]];
